Feature: Topics
  ...
  Scenario: create topic
    Given I have logged in as devin
      ...
      Then I should see 创建新主题
      When I click the link 创建新主题
        Then I should be redirected to the topic creation page
        And it should display a topic creation form
        And I should see 主题创建指南
  ...
  Scenario: show topic comment sequence id on one page
    Given a topic exists with title: 那继续晒一下韩国电影吧
      And the topic has comments of 1 page
      And I am on the topic page
      Then I should see #1
        And I should see #2
  ...
  Scenario: topic hit
    Given a topic exists with title: Hi
      And I am on the topic page
      Then I should see 1次点击
      When I am on the topic page
      Then I should see 2次点击
  ...
  Scenario: mark all notifications as read
    Given I have logged in as devin
      And a notification exists with user: devin
      When I am on the notifications page
        Then page title should contain 1
        And I should see 全部标记为已读
        When I click the link 全部标记为已读
          Then page title should not contain 1
